...
#
# ============================================================================
#  Project       : Axios Supply Chain Attack — Detection Script
...
#
#  This script and its contents are the exclusive intellectual property of
#  Tomorrow Systems. Unauthorized copying, modification, distribution, or
#  use of this software, in whole or in part, without prior written
#  permission from Tomorrow Systems is strictly prohibited.
#
...
# ============================================================================
#
#  DESCRIPTION  : Checks if your system was affected by the axios@1.14.1 /
#                 axios@0.30.4 supply chain attack that dropped a cross-
#                 platform RAT via plain-crypto-js.
#
